export type TokenizedEndpoint = [string, string[]];

export interface Endpoints {
  host: string;
  login_param: string;
  login: string;
  logout: TokenizedEndpoint;
  user_details: TokenizedEndpoint;
  access_token: TokenizedEndpoint;
  place_regular: TokenizedEndpoint;
  modify_regular: TokenizedEndpoint;
  cancel_regular: TokenizedEndpoint;
  convert_regular: TokenizedEndpoint;
  place_cover: TokenizedEndpoint;
  modify_cover: TokenizedEndpoint;
  exit_cover: TokenizedEndpoint;
  place_bracket: TokenizedEndpoint;
  modify_bracket: TokenizedEndpoint;
  exit_bracket: TokenizedEndpoint;
  order_book: TokenizedEndpoint;
  orders: TokenizedEndpoint;
  trade_details: TokenizedEndpoint;
  position: TokenizedEndpoint;
  position_details: TokenizedEndpoint;
  funds_summary: TokenizedEndpoint;
  holdings_value: TokenizedEndpoint;
  user_holdings_data: TokenizedEndpoint;
  charges_info: TokenizedEndpoint;
  security_master: TokenizedEndpoint;
  scrips_margin: TokenizedEndpoint;
  order_margin: TokenizedEndpoint;
  generate_tpin: TokenizedEndpoint;
  validate_tpin: TokenizedEndpoint;
  status: TokenizedEndpoint;
  price_chart_sym: TokenizedEndpoint;
  gtt: TokenizedEndpoint;
  gtt_by_id: TokenizedEndpoint;
  gtt_aggregate: TokenizedEndpoint;
  expiry_gtt: TokenizedEndpoint;
  gtt_by_instruction_id: TokenizedEndpoint;
  gtt_v2: TokenizedEndpoint;
  gtt_by_id_v2: TokenizedEndpoint;
  gtt_by_instruction_id_v2: TokenizedEndpoint;
  live_market_data: TokenizedEndpoint;
  option_chain: TokenizedEndpoint;
  option_chain_config: TokenizedEndpoint;
